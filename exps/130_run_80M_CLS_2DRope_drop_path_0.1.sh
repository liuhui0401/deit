...
exps=80M_CLS_2DRope_No_Cached_Dataset_Stransform_2.5e-4_gpu4_drop_path_0.1
mkdir -p results/${exps}


CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --master_port=28392 --nproc_per_node 8 main.py \
