...
from cached_image_folder_wenhai import ImageCephDataset
from samplers import NodeDistributedSampler
...
#    dataset_train = datasets.ImageFolder(os.path.join(args.data_path, 'train'), transform=transform_train)
    dataset_train = ImageCephDataset(os.path.join(args.data_path, 'train'), 'train', transform=transform_train, on_memory=True)
